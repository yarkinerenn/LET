...
const ExplanationPageDashboard = () => {
    ...
    const [classification, setClassification] = useState<PredictionEntry | null>(null);
    ...
    useEffect(() => {
        ...
        fetchData();
    }, []); // Add resultId to dependency array
                                    ...
                                    <div className={`transition-all ${activeExplanation === 'llm' ? 'opacity-100 z-1' : 'opacity-0 z-0'}`}
                                        ...
                                        <div className="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <Button
                                                ...
                                                size="sm"
                                                onClick={() => generateExplanation('llm')}
...
export default ExplanationPageDashboard;