...
def plausibility(ground_context, ground_question, ground_explanation, target_model, groq,provider,api, ner_pipe=None, row_reference= None):
    """
    ...
    # Compute Consistency
    iter_stab, para_stab, cons = consistency(ground_question, ground_context, target_model, ground_explanation, groq,provider,api, ner_pipe, row_reference)
